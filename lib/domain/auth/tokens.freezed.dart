...
class _$_Tokens implements _Tokens {
  const _$_Tokens(@JsonKey(name: 'access_token') this.accessToken,
...
abstract class _Tokens implements Tokens {
  const factory _Tokens(@JsonKey(name: 'access_token') final String accessToken,
      @JsonKey(name: 'refresh_token') final String refreshToken) = _$_Tokens;
