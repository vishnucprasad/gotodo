...
import 'package:gotodo/application/app/app_bloc.dart' as _i13;
import 'package:gotodo/application/auth/auth_bloc.dart' as _i14;
...
import 'package:gotodo/application/statistics/statistics_bloc.dart' as _i11;
import 'package:gotodo/application/todo/todo_bloc.dart' as _i12;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i11.StatisticsBloc>(
      () => _i11.StatisticsBloc(
        gh<_i5.IAuthFacade>(),
        gh<_i7.ITodoRepo>(),
      ),
    ...
    gh.factory<_i13.AppBloc>(
      () => _i13.AppBloc(gh<_i3.IAppRepo>()),
      registerFor: {_prod},
    );
    gh.factory<_i14.AuthBloc>(
      () => _i14.AuthBloc(gh<_i5.IAuthFacade>()),
      registerFor: {_prod},
    );
    return this;
  }
